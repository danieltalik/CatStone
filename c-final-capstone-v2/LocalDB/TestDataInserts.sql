...
INSERT INTO Cats (name, color, hair_length, age, prior_exp, photo, is_featured, description, isEmployed ) VALUES ('Percy',		'orange $ white', 'Long',  12, 'Purficient at wakeup calls',						'Percy.jpg',	1, '', 0)
INSERT INTO Cats (name, color, hair_length, age, prior_exp, photo, is_featured, description, isEmployed ) VALUES ('Fern',		'tabby',		  'long',   8, 'Will do anything for bread.',						'fern.jpg',		0, '', 0)
INSERT INTO Cats (name, color, hair_length, age, prior_exp, photo, is_featured, description, isEmployed ) VALUES ('Luna',		'Black & Orange', 'short',  3, 'Flexible for the right opportunity',				'luna.jpg',		0, '', 0)
INSERT INTO Cats (name, color, hair_length, age, prior_exp, photo, is_featured, description, isEmployed ) VALUES ('Picard',		'orange',		  'short',  7, 'Licking, Stealing food, Commanding USS Enterprise', 'picard.jpg',	0, '', 0)
INSERT INTO Cats (name, color, hair_length, age, prior_exp, photo, is_featured, description, isEmployed ) VALUES ('Memesiku',	'calico',		  'long',   9, 'Flooping, Drooling, Hunting gnats',					'memsiku.jpg',	1, '', 0)
INSERT INTO Cats (name, color, hair_length, age, prior_exp, photo, is_featured, description, isEmployed ) VALUES ('Wulfgang',	'black',		  'long',   7, 'Always looking for new ways to assinate dogs',		'wulfgang.jpg', 0, '', 0)
INSERT INTO Cats (name, color, hair_length, age, prior_exp, photo, is_featured, description, isEmployed ) VALUES ('Brahm',		'brown',		  'short',  5, '100% good boy 0% cat',								'brahm.jpg',	0, '', 0)
...
INSERT INTO Reviews (user_id, cat_id, date, rating) VALUES (1, 4, GETDATE(), 5)
INSERT INTO Reviews (user_id, cat_id, date, rating) VALUES (1, 5, GETDATE(), 5)
INSERT INTO Reviews (user_id, cat_id, date, rating) VALUES (1, 6, GETDATE(), 4)
INSERT INTO Reviews (user_id, cat_id, date, rating) VALUES (2, 7, GETDATE(), 2)
INSERT INTO Reviews (user_id, cat_id, date, rating) VALUES (3, 1, GETDATE(), 3)
INSERT INTO Reviews (user_id, cat_id, date, rating) VALUES (3, 2, GETDATE(), 4)
INSERT INTO Reviews (user_id, cat_id, date, rating) VALUES (3, 3, GETDATE(), 4)
--INSERT INTO Reviews (user_id, cat_id, date, rating) VALUES (, , , ,)

INSERT INTO Success_Stories (cat_id, user_id, date, comment) VALUES(4, 1, GETDATE(), 'Picard has really taken an interest in the cleanliness of my hands')
INSERT INTO Success_Stories (cat_id, user_id, date, comment) VALUES(5, 1, GETDATE(), 'Memesiku is very inviting to strangers, tolerates superiors')
INSERT INTO Success_Stories (cat_id, user_id, date, comment) VALUES(6, 1, GETDATE(), 'Never have I met a cat more determined to kill dogs')
INSERT INTO Success_Stories (cat_id, user_id, date, comment) VALUES(7, 2, GETDATE(), 'Brahm does his best to fit in')
