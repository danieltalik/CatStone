...
namespace c_final_capstone_v2.App_Start
{
    ...
    public static class NinjectWebCommon
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IReviewSqlDao>().To<ReviewSqlDao>().WithConstructorArgument("connectionString", ConfigurationManager.ConnectionStrings["CatStoneConnection"].ConnectionString);
        }
    }
}